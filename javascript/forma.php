<?php
 ...
 $campos = array('nombre',
  ...
  //elegir un archivo
  'archivo'=>'<input type="file" name="adjunto" accept=".pdf,.jpg,.png" multiple/>');
 $atributos = array('form'=>'id="inserta" action="insertar.php" method="POST"');
 $atrib= array ('form'=>'archivo="inserta" action="insertar.php" method="POST" enctype="multipart/form-data"');
 HTML::forma($liga, 'Nuevo usuario', $campos, $atributos,$atrib);
